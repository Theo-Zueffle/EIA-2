...
(function (canvas2) {
    ...
    function generateDTree(){
     ...
     generateDTree();
     generateDTree();*/
    function drawDeciduousTree(_position) {
        ...
        drawCircles(30, -120, 45);
        function drawCircles(_x, _y, _radius) {
            crc2.beginPath();
    ...
    function drawLeaf() {
        ...
        for (let drawn = 0; drawn < nLeafs; drawn++) {
            crc2.save();
            //x += x + Math.round(Math.random());
    ...
    function drawLeave1() {
        let color1 = Math.floor(Math.random() * 150);
        let color2 = Math.floor(Math.random() * 1);
